...
def main():
    ...
    if '--assert' in sys.argv:
        ...
        expect = [('845', total, 'total'), ('469', counts['kidFriendly'], 'kidFriendly'),
                  ('208', counts['afterDark'], 'afterDark'), ('229', counts['stepFree'], 'stepFree'),
                  ('728', counts['scamWarnings'], 'scamWarnings'),
                  ('372', counts['scam_nonempty'], 'scam_nonempty')]
