...
export let VISA = {};
// LAZY-MODULE: zones = zonesFor getZone zoneForProvince monthVerdict zonesByMonth
...
export function monthVerdict(zone, month) { const m = _mods.zones; return m ? m.monthVerdict(zone, month) : 'shoulder'; }
export function zonesByMonth(cc, month) { const m = _mods.zones; return m ? m.zonesByMonth(cc, month) : []; }
