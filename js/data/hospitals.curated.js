...
export const HOSPITALS = [
  ...
  { cc: 'vi', prov: 'Hòa Bình', city: 'Hoa Binh', lat: 20.8258, lng: 105.3542, name: 'Hoa Binh General Hospital', tier: 'public', tags: ['er', 'maternity'], note: 'The provincial hospital for Mai Chau — roughly 1.5-2 hours down Highway 6.' },
  { cc: 'vi', prov: 'Hòa Bình', city: 'Mai Chau', lat: 20.6558, lng: 105.0791, name: 'Mai Chau Regional Health Centre', tier: 'district', tags: ['er'], note: 'District level, in Mai Chau town. Homestay and cycling injuries are stabilised here and sent to Hoa Binh City or Hanoi for anything serious.' },
