...
export const PHRASEBOOK_MS = {
  ...
  categories: [
    { id: 'basics', name: 'Greetings & basics', phrases: [
      ...
      { en: 'Friend', script: 'Kawan', roman: 'ka-wan' },
    ]},
    { id: 'questions', name: 'Question words', phrases: [
      { en: 'Who?', script: 'Siapa?', roman: 'see-ah-pa' },
      { en: 'What?', script: 'Apa?', roman: 'ah-pa' },
      { en: 'Where?', script: 'Di mana?', roman: 'dee ma-na', note: 'Put the thing after it: "Di mana tandas?" = where is the toilet.' },
      { en: 'When?', script: 'Bila?', roman: 'bee-la' },
      { en: 'Why?', script: 'Kenapa?', roman: 'ke-na-pa', note: 'More formal: "Mengapa?" (meng-ah-pa).' },
    ]},
    ...
    { id: 'numbers', name: 'Numbers', phrases: [
      { en: 'One', script: 'satu', roman: 'sa-too' },
      { en: 'Two', script: 'dua', roman: 'doo-ah' },
      { en: 'Three', script: 'tiga', roman: 'tee-ga' },
      { en: 'Four', script: 'empat', roman: 'em-pat' },
      { en: 'Five', script: 'lima', roman: 'lee-ma' },
      { en: 'Six', script: 'enam', roman: 'eh-nam' },
      { en: 'Seven', script: 'tujuh', roman: 'too-jooh' },
      { en: 'Eight', script: 'lapan', roman: 'la-pan', note: 'In Indonesian it is "delapan"; both are understood.' },
      { en: 'Nine', script: 'sembilan', roman: 'sem-bee-lan' },
      { en: 'Ten', script: 'sepuluh', roman: 'se-poo-looh' },
      { en: 'Twenty', script: 'dua puluh', roman: 'doo-ah poo-looh' },
      { en: 'Thirty', script: 'tiga puluh', roman: 'tee-ga poo-looh' },
      { en: 'Forty', script: 'empat puluh', roman: 'em-pat poo-looh' },
      { en: 'Fifty', script: 'lima puluh', roman: 'lee-ma poo-looh' },
      { en: 'Sixty', script: 'enam puluh', roman: 'eh-nam poo-looh' },
      { en: 'Seventy', script: 'tujuh puluh', roman: 'too-jooh poo-looh' },
      { en: 'Eighty', script: 'lapan puluh', roman: 'la-pan poo-looh' },
      { en: 'Ninety', script: 'sembilan puluh', roman: 'sem-bee-lan poo-looh' },
      { en: 'Hundred', script: 'seratus', roman: 'se-ra-toos' },
      { en: 'Thousand', script: 'seribu', roman: 'se-ree-boo' },
    ]},
