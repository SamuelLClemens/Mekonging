...
export const PLACES_LA_EXT = [
  ...
  },
  {
    ...
    afterDark: { openAfterDark: false, note: "From this entry's own listed hours (08:00-18:00 daily), which end at or before typical dusk in the region (about 17:45-18:45 by season), so a visit does not run past dark." },
  ...
  },
  {
    ...
    afterDark: { openAfterDark: false, note: "From this entry's own listed hours (Roughly 08:00-17:00 daily), which end at or before typical dusk in the region (about 17:45-18:45 by season), so a visit does not run past dark." },
  ...
  },
{
  ...
  },
  {
    ...
    afterDark: { openAfterDark: false, note: "From this entry's own listed hours (Roughly 08:00-12:00 and 13:00-16:00 daily), which end at or before typical dusk in the region (about 17:45-18:45 by season), so a visit does not run past dark." },
  ...
  },
  {
    ...
    afterDark: { openAfterDark: false, note: "From this entry's own listed hours (Roughly 08:00-18:00 daily), which end at or before typical dusk in the region (about 17:45-18:45 by season), so a visit does not run past dark." },
  ...
  },
  {
    ...
    afterDark: { openAfterDark: false, note: "From this entry's own listed hours (Daily, roughly 06:00-08:00 (busiest at dawn)), which end at or before typical dusk in the region (about 17:45-18:45 by season), so a visit does not run past dark." },
  ...
  },
  {
    ...
    "afterDark": {
      "openAfterDark": false,
      "note": "From this entry's own listed hours (Daily, roughly 08:00-17:00), which end at or before typical dusk in the region (about 17:45-18:45 by season), so a visit does not run past dark."
    },
    "tips": [
  ...
  },
  {
    ...
    "afterDark": {
      "openAfterDark": false,
      "note": "From this entry's own listed hours (Roughly 06:00-18:00 daily), which end at or before typical dusk in the region (about 17:45-18:45 by season), so a visit does not run past dark."
    },
    "tips": [
  ...
  },
  {
    ...
    "afterDark": {
      "openAfterDark": false,
      "note": "From this entry's own listed hours (Roughly 08:00-17:00 daily), which end at or before typical dusk in the region (about 17:45-18:45 by season), so a visit does not run past dark."
    },
    "tips": [
  ...
  },
  {
    ...
    "afterDark": {
      "openAfterDark": false,
      "note": "From this entry's own listed hours (Daylight hours, roughly 08:00-17:00), which end at or before typical dusk in the region (about 17:45-18:45 by season), so a visit does not run past dark."
    },
    "tips": [
  ...
  },
  {
    ...
    afterDark: { openAfterDark: true, note: "From this entry's own listed hours (Daily roughly 17:00-22:00), which run past typical dusk in the region (about 17:45-18:45 by season). Lighting is not recorded." },
  ...
  },
  {
    ...
    name: "Bicycle & scooter rental, Luang Prabang",
    city: "Luang Prabang",
    country: "la",
    ...
    afterDark: { openAfterDark: true, note: "From this entry's own listed hours (Roughly 08:00-20:00 daily), which run past typical dusk in the region (about 17:45-18:45 by season). Lighting is not recorded." },
  ...
  },
  {
    ...
    name: "Motorbike rental, Thakhek (Thakhek Loop)",
    city: "Thakhek",
    country: "la",
    categories: ["rental", "transport"],
    budgetTier: "low",
  ...
  {
    id: "la-ext-nongkhiaw-deens-indian-food", name: "Deen's Indian Food", city: "Nong Khiaw", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 4.0, scale: 5, count: 328, url: "https://www.tripadvisor.com/Restaurant_Review-g1520128-d1550577-Reviews-Deen_s_Indian_Food-Nong_Khiaw_Luang_Prabang_Province.html", asOf: "2026-07" },
    ],
    categories: ["food", "restaurant"], budgetTier: "low",
    isLocal: false, kidFriendly: true,
    blurb: "A long-running Indian restaurant just south of the Nong Khiaw bridge, run by an owner originally from India who has cooked here for years. Curries, dal, papadams and malai kofta are made fresh to order and served with rice or naan.",
    whyItFits: "A welcome change of cuisine after days of Lao noodle soups, and reliably one of the best-reviewed sit-down meals in the village.",
    priceRange: { low: 20000, typical: 45000, high: 80000, currency: "LAK", note: "Per person for a curry, rice and a drink; sharing a thali plate costs more." },
    hours: "Roughly 07:00-22:00 daily",
    afterDark: { openAfterDark: true, note: "From this entry's own listed hours (Roughly 07:00-22:00 daily), which run past typical dusk in the region (about 17:45-18:45 by season). Lighting is not recorded." },
    tips: ["Order the malai kofta or a chicken curry with garlic naan — the house specialities.", "Go a little early for dinner in high season, as the small dining room fills up.", "It sits on the main road just south of the bridge, an easy walk from most guesthouses."],
    scamWarnings: [],
    rating: 4.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Deen's Indian Food Nong Khiaw", coords: { lat: 20.5715, lng: 102.6182 },
    bookHint: "Walk in; no reservations taken.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Restaurant_Review-g1520128-d1550577-Reviews-Deen_s_Indian_Food-Nong_Khiaw_Luang_Prabang_Province.html" }],
  },
  {
    id: "la-ext-nongkhiaw-delilahs-place", name: "Delilah's Place", city: "Nong Khiaw", country: "la",
    categories: ["food", "cafe"], budgetTier: "low",
    isLocal: false, kidFriendly: true,
    blurb: "A long-standing cafe on Nong Khiaw's main street known for a big breakfast menu, homemade cakes and desserts, and the village's only pool table. A relaxed spot to write postcards or watch a film between treks.",
    whyItFits: "The village's go-to all-day cafe for travellers wanting good coffee, baked goods and a comfortable place to linger, distinct from the riverside grill stalls.",
    priceRange: { low: 15000, typical: 35000, high: 60000, currency: "LAK", note: "Per person for a breakfast plate or cake and a coffee; fuller meals cost a little more." },
    hours: "Roughly 07:00-21:00 daily",
    afterDark: { openAfterDark: true, note: "From this entry's own listed hours (Roughly 07:00-21:00 daily), which run past typical dusk in the region (about 17:45-18:45 by season). Lighting is not recorded." },
    tips: ["The homemade cakes and desserts are the reason regulars keep coming back.", "Good spot for a proper Western breakfast before an early trek or viewpoint climb.", "The attached rooms make it a useful landmark for meeting up on the main street."],
    scamWarnings: [],
    rating: 3.8, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Delilah's Place Nong Khiaw", coords: { lat: 20.5670, lng: 102.6165 },
    bookHint: "Walk in; no reservations taken.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Restaurant_Review-g1520128-d2520313-Reviews-Delilah_s_Place-Nong_Khiaw_Luang_Prabang_Province.html" }],
  },
  {
    id: "la-ext-nongkhiaw-vongmany", name: "Vongmany", city: "Nong Khiaw", country: "la",
    categories: ["food", "restaurant"], budgetTier: "low",
    isLocal: true, kidFriendly: true,
    blurb: "A family-run restaurant and guesthouse in the village serving straightforward, well-cooked Lao food — laap, stir-fries, soups and rice dishes — praised by travellers as some of the best home-style Lao cooking in Nong Khiaw.",
    whyItFits: "For travellers wanting a genuinely Lao (rather than Western-leaning) sit-down meal cooked by a local family, a useful counterpoint to the village's Indian and Western menus.",
    priceRange: { low: 20000, typical: 40000, high: 70000, currency: "LAK", note: "Per person for a rice dish or soup and a drink." },
    hours: "Roughly 07:00-21:00 daily",
    afterDark: { openAfterDark: true, note: "From this entry's own listed hours (Roughly 07:00-21:00 daily), which run past typical dusk in the region (about 17:45-18:45 by season). Lighting is not recorded." },
    tips: ["Ask what is fresh that day — the small kitchen cooks to order rather than running a big menu.", "It also rents simple rooms if you want to stay where you eat.", "A good option when the more touristy strip nearer the bridge is full."],
    scamWarnings: [],
    rating: 3.7, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Vongmany Restaurant Nong Khiaw", coords: { lat: 20.5660, lng: 102.6170 },
    bookHint: "Walk in; no reservations needed.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Restaurant_Review-g1520128-d2065446-Reviews-Vongmany-Nong_Khiaw_Luang_Prabang_Province.html" }],
  },
  {
    id: "la-ext-nongkhiaw-mandala-ou-resort", name: "Mandala Ou Resort", city: "Nong Khiaw", country: "la",
    categories: ["stay", "resort"], budgetTier: "high",
    stayType: "resort", stayDuration: "short", kidFriendly: true,
    amenities: ["riverfront", "restaurant", "garden", "fan-or-air-con", "organic-farm"],
    blurb: "An eco-focused riverside resort about 1 km from the village centre, built from wood and stone bungalows set in landscaped gardens above the Nam Ou. Grows much of its own produce and looks straight across the river to the karst peaks.",
    whyItFits: "Nong Khiaw's top-rated place to stay for travellers wanting a quiet, scenic splurge after a day on the viewpoints, without leaving the village behind entirely.",
    priceRange: { low: 900000, typical: 1500000, high: 2400000, currency: "LAK", note: "Per night for a river-view bungalow; rates vary by season and room category." },
    hours: "Check-in typically from 14:00",
    tips: ["It is a flat 15-minute walk or short tuk-tuk ride from the village centre and bus station.", "Ask about the organic garden and farm-to-table dinner menu.", "Book ahead in the November-February high season, as the resort has few rooms."],
    scamWarnings: [],
    rating: 4.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Mandala Ou Resort Nong Khiaw", coords: { lat: 20.5696, lng: 102.6107 },
    bookHint: "Book direct through the resort's website or via Booking.com/Agoda ahead of high season.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Hotel_Review-g1520128-d5457346-Reviews-Mandala_Ou_Resort-Nong_Khiaw_Luang_Prabang_Province.html" }],
  },
  {
    id: "la-ext-nongkhiaw-riverside-resort", name: "Nong Kiau Riverside", city: "Nong Khiaw", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 4.0, scale: 5, count: 416, url: "https://www.tripadvisor.com/Hotel_Review-g1520128-d1550304-Reviews-Nong_Kiau_Riverside-Nong_Khiaw_Luang_Prabang_Province.html", asOf: "2026-07" },
    ],
    categories: ["stay", "resort"], budgetTier: "mid",
    stayType: "resort", stayDuration: "short", kidFriendly: true,
    amenities: ["riverfront", "restaurant", "terrace", "fan-or-air-con"],
    blurb: "Individual teak-and-thatch cabins on stilts cantilevered along the Nam Ou at the south end of the village bridge, one of the original riverside lodges in Nong Khiaw and still one of its best-known. Its own restaurant overlooks the water and karst peaks opposite.",
    whyItFits: "A long-established, dependable riverside base right by the bridge — walkable to the viewpoint trailhead and the village centre, with the classic Nong Khiaw river-and-karst view from every cabin.",
    priceRange: { low: 350000, typical: 550000, high: 900000, currency: "LAK", note: "Per night for a standard riverside cabin; larger or premium cabins cost more." },
    hours: "Check-in typically from 13:00",
    tips: ["Ask for a cabin facing directly across the river for the best karst view.", "The on-site restaurant is a pleasant sunset spot even if you are not staying here.", "It sits at the south end of the bridge, an easy walk from the bus stop."],
    scamWarnings: [],
    rating: 4.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Nong Kiau Riverside Nong Khiaw", coords: { lat: 20.5704, lng: 102.6174 },
    bookHint: "Book direct via nongkiau.com or through Booking.com/Agoda, especially in high season.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Hotel_Review-g1520128-d1550304-Reviews-Nong_Kiau_Riverside-Nong_Khiaw_Luang_Prabang_Province.html" }],
  },

  {
    id: "la-ext-luangnamtha-bamboo-lounge", name: "Bamboo Lounge", city: "Luang Namtha", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 4.2, scale: 5, count: 280, url: "https://www.tripadvisor.com/Restaurant_Review-g424933-d3245866-Reviews-Bamboo_Lounge-Luang_Namtha_Luang_Namtha_Province.html", asOf: "2026-07" },
    ],
    categories: ["food", "restaurant", "cafe"], budgetTier: "mid",
    isLocal: false, kidFriendly: true,
    blurb: "A social-enterprise restaurant on the main road in central Luang Namtha, serving woodfired pizza, homemade pasta, big breakfasts and real espresso. All-local ethnic-minority staff train here in hospitality and English, and profits fund a books-in-schools programme.",
    whyItFits: "Top-rated in town for travellers wanting reliable Western comfort food and fast wifi between Nam Ha treks, with a concrete community benefit to the bill.",
    priceRange: { low: 40000, typical: 80000, high: 150000, currency: "LAK", note: "Per person for a pizza or pasta and a drink; breakfasts and sandwiches cost less." },
    hours: "Daily roughly 10:00-22:00",
    afterDark: { openAfterDark: true, note: "From this entry's own listed hours (Daily roughly 10:00-22:00), which run past typical dusk in the region (about 17:45-18:45 by season). Lighting is not recorded." },
    tips: ["The woodfired pizza and cocktails are the standout order.", "Vegan and gluten-free options are clearly marked on the menu.", "It sits on the main road near the town centre, an easy walk from most guesthouses."],
    scamWarnings: [],
    rating: 4.2, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Bamboo Lounge Luang Namtha", coords: { lat: 20.9490, lng: 101.4040 },
    bookHint: "Walk in; no reservations needed outside of large groups.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Restaurant_Review-g424933-d3245866-Reviews-Bamboo_Lounge-Luang_Namtha_Luang_Namtha_Province.html" }],
  },
  {
    id: "la-ext-luangnamtha-zuela-restaurant", name: "Zuela Restaurant", city: "Luang Namtha", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 4.0, scale: 5, count: 185, url: "https://www.tripadvisor.com/Restaurant_Review-g424933-d2147303-Reviews-Zuela_Restaurant-Luang_Namtha_Luang_Namtha_Province.html", asOf: "2026-07" },
    ],
    categories: ["food", "restaurant"], budgetTier: "low",
    isLocal: false, kidFriendly: true,
    blurb: "A long-running backpacker restaurant opposite the night market, open from early morning for a wide breakfast and bakery menu, then a big all-day spread of cheap Lao, Thai and Western dishes such as fried rice, noodles and meat-and-veg curries.",
    whyItFits: "A dependable, low-cost all-rounder in the town centre for trekkers refuelling before or after a Nam Ha Protected Area trip.",
    priceRange: { low: 15000, typical: 35000, high: 60000, currency: "LAK", note: "Per person for a rice or noodle dish; the apple muffins and bakery items are a few thousand kip each." },
    hours: "Daily roughly 06:30-22:00",
    afterDark: { openAfterDark: true, note: "From this entry's own listed hours (Daily roughly 06:30-22:00), which run past typical dusk in the region (about 17:45-18:45 by season). Lighting is not recorded." },
    tips: ["Try the apple muffin and bakery items with breakfast.", "It doubles as a guesthouse and motorbike-rental point if you need either.", "Located directly opposite the night market, an easy central landmark."],
    scamWarnings: [],
    rating: 4.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Zuela Restaurant Luang Namtha", coords: { lat: 20.9490, lng: 101.4038 },
    bookHint: "Walk in; no reservations needed.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Restaurant_Review-g424933-d2147303-Reviews-Zuela_Restaurant-Luang_Namtha_Luang_Namtha_Province.html" }],
  },
  {
    id: "la-ext-luangnamtha-zuela-guesthouse", name: "Zuela Guesthouse", city: "Luang Namtha", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 3.0, scale: 5, count: 382, url: "https://www.tripadvisor.com/Hotel_Review-g424933-d1405832-Reviews-Zuela_Guesthouse-Luang_Namtha_Luang_Namtha_Province.html", asOf: "2026-07" },
    ],
    categories: ["stay", "guesthouse"], budgetTier: "low",
    stayType: "guesthouse", stayDuration: "short", kidFriendly: true,
    amenities: ["restaurant", "bicycle-rental", "motorbike-rental", "tour-desk", "wifi", "fan-or-air-con"],
    blurb: "A well-known budget guesthouse directly across from the Luang Namtha night market, with simple clean rooms, an on-site restaurant and its own bicycle and motorbike rental and trekking desk.",
    whyItFits: "A reliable, centrally located budget base for organising Nam Ha treks, bike hire and onward transport, all from one compound.",
    priceRange: { low: 100000, typical: 180000, high: 350000, currency: "LAK", note: "Per night for a simple fan or air-con room; prices rise a little in high season." },
    hours: "Check-in typically from 13:00",
    tips: ["Book direct rather than through an agency for the best rate.", "Staff can arrange bicycle, motorbike hire and treks on site.", "Being right across from the night market makes it an easy evening food stop."],
    scamWarnings: [],
    rating: 3.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Zuela Guesthouse Luang Namtha", coords: { lat: 20.9491, lng: 101.4036 },
    bookHint: "Book direct by phone/Facebook, or via Booking.com/Agoda.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Hotel_Review-g424933-d1405832-Reviews-Zuela_Guesthouse-Luang_Namtha_Luang_Namtha_Province.html" }],
  },
  {
    id: "la-ext-luangnamtha-boat-landing", name: "The Boat Landing Guest House", city: "Luang Namtha", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 3.0, scale: 5, count: 95, url: "https://www.tripadvisor.com/Hotel_Review-g424933-d325837-Reviews-The_Boat_Landing_Guest_House-Luang_Namtha_Luang_Namtha_Province.html", asOf: "2026-07" },
    ],
    access: { stepFree: "no", note: "Bamboo bungalows are raised on stilts with wooden steps, and several reviews note traditional squat toilets rather than Western fixtures; not step-free." },
    categories: ["stay", "guesthouse"], budgetTier: "mid",
    stayType: "guesthouse", stayDuration: "short", kidFriendly: true,
    amenities: ["riverfront", "restaurant", "garden", "front-desk"],
    blurb: "A pioneering eco-lodge on the banks of the Nam Tha river about 6-7 km south of town near the airport, run with the local Kalom family and long known for its restaurant of authentic northern Lao dishes rarely found on tourist menus. Bamboo bungalows are simple but full of river-view character.",
    whyItFits: "For travellers who want to swap the town centre for a genuinely local riverside setting and one of the region's most respected sustainable-tourism restaurants.",
    priceRange: { low: 350000, typical: 550000, high: 900000, currency: "LAK", note: "Per night for a bamboo river-view bungalow; older or garden-facing rooms cost less." },
    hours: "Check-in typically from 14:00",
    tips: ["The restaurant is worth the trip even without staying, for genuinely local Lao dishes cooked by the Kalom family.", "It is a few kilometres from town, so arrange a tuk-tuk or your own transport.", "Expect a simpler, more rustic style than in-town guesthouses — bring an open mind about traditional bathrooms."],
    scamWarnings: [],
    rating: 3.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "The Boat Landing Guest House Luang Namtha", coords: { lat: 20.8850, lng: 101.4050 },
    bookHint: "Book direct by phone/email or via Booking.com/Agoda ahead of arrival, since it is out of town.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Hotel_Review-g424933-d325837-Reviews-The_Boat_Landing_Guest_House-Luang_Namtha_Luang_Namtha_Province.html" }],
  },
  {
    id: "la-ext-luangnamtha-thoulasith-guesthouse", name: "Thoulasith Guesthouse", city: "Luang Namtha", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 3.0, scale: 5, count: 183, url: "https://www.tripadvisor.com/Hotel_Review-g424933-d1748985-Reviews-Thoulasith_Guesthouse-Luang_Namtha_Luang_Namtha_Province.html", asOf: "2026-07" },
    ],
    categories: ["stay", "guesthouse"], budgetTier: "low",
    stayType: "guesthouse", stayDuration: "short", kidFriendly: true,
    amenities: ["wifi", "fan-or-air-con", "front-desk", "convenience-store"],
    blurb: "A quiet, well-located budget guesthouse in central Luang Namtha with light, clean rooms, TVs, private bathrooms and a choice of fan or air-con — a straightforward base for exploring the town and arranging Nam Ha treks.",
    whyItFits: "A dependable, centrally placed budget option for travellers who want simple, comfortable rooms without the price step-up of the resort-style stays.",
    priceRange: { low: 90000, typical: 160000, high: 280000, currency: "LAK", note: "Per night for a fan or air-con double room." },
    hours: "Check-in typically from 13:00",
    tips: ["Rooms with air-con cost a little more and are worth it in the hot season.", "Central location makes it an easy walk to the night market and bus station.", "Ask staff for advice on trekking agencies, as they know the town well."],
    scamWarnings: [],
    rating: 3.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Thoulasith Guesthouse Luang Namtha", coords: { lat: 20.9500, lng: 101.4010 },
    bookHint: "Book via Booking.com/Agoda, or walk in outside peak season.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Hotel_Review-g424933-d1748985-Reviews-Thoulasith_Guesthouse-Luang_Namtha_Luang_Namtha_Province.html" }],
  },

  {
    id: "la-ext-savannakhet-lao-deam", name: "Savan Lao Deam", city: "Savannakhet", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 4.0, scale: 5, count: 25, url: "https://www.tripadvisor.com/Restaurant_Review-g811038-d1379185-Reviews-Savan_Lao_Deam-Savannakhet_Savannakhet_Province.html", asOf: "2026-07" },
    ],
    categories: ["food", "restaurant"], budgetTier: "mid",
    isLocal: true, kidFriendly: true,
    blurb: "A large open-sided restaurant built out over the Mekong a couple of kilometres north of central Savannakhet, serving Lao and Thai dishes to a view straight across the river to Thailand. Popular for a sunset dinner with a mango shake or a cold Beerlao.",
    whyItFits: "The most scenic sit-down dinner in Savannakhet, and a natural way to make use of the town's quiet riverfront setting.",
    priceRange: { low: 30000, typical: 60000, high: 120000, currency: "LAK", note: "Per person for a main dish and a drink; sharing several dishes costs more." },
    hours: "Roughly 10:00-22:00 daily",
    afterDark: { openAfterDark: true, note: "From this entry's own listed hours (Roughly 10:00-22:00 daily), which run past typical dusk in the region (about 17:45-18:45 by season). Lighting is not recorded." },
    tips: ["Time your visit for sunset over the Mekong.", "It is a couple of kilometres north of the centre, so take a tuk-tuk or rented bike.", "Order a Mekong fish dish if available — a house strength."],
    scamWarnings: [],
    rating: 4.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Savan Lao Deam restaurant Savannakhet", coords: { lat: 16.5750, lng: 104.7460 },
    bookHint: "Walk in, or ask your guesthouse to arrange a tuk-tuk; no advance booking needed.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Restaurant_Review-g811038-d1379185-Reviews-Savan_Lao_Deam-Savannakhet_Savannakhet_Province.html" }],
  },
  {
    id: "la-ext-savannakhet-lao-house-restaurant", name: "Lao House Restaurant", city: "Savannakhet", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 3.9, scale: 5, count: 15, url: "https://www.tripadvisor.com/Restaurant_Review-g811038-d7929629-Reviews-Lao_House_Restaurant-Savannakhet_Savannakhet_Province.html", asOf: "2026-07" },
    ],
    categories: ["food", "restaurant"], budgetTier: "low",
    isLocal: true, kidFriendly: true,
    blurb: "A central Savannakhet restaurant on Road No. 9 serving mostly Lao dishes alongside some Thai and Vietnamese standards — a straightforward, unpretentious sit-down meal within walking distance of the old French quarter.",
    whyItFits: "A convenient, centrally located dinner option for travellers based in the old town near the museums and riverfront.",
    priceRange: { low: 25000, typical: 45000, high: 80000, currency: "LAK", note: "Per person for a rice or noodle dish and a drink." },
    hours: "Roughly 08:00-21:00 daily",
    afterDark: { openAfterDark: true, note: "From this entry's own listed hours (Roughly 08:00-21:00 daily), which run past typical dusk in the region (about 17:45-18:45 by season). Lighting is not recorded." },
    tips: ["It is an easy walk from the Dinosaur Museum and the old French quarter.", "Ask staff for the Lao specialities rather than the more generic Thai/Vietnamese dishes.", "Good option for a quiet, unhurried dinner away from the riverfront crowd."],
    scamWarnings: [],
    rating: 3.9, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Lao House Restaurant Savannakhet", coords: { lat: 16.5636, lng: 104.7503 },
    bookHint: "Walk in; no reservations needed.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Restaurant_Review-g811038-d7929629-Reviews-Lao_House_Restaurant-Savannakhet_Savannakhet_Province.html" }],
  },
  {
    id: "la-ext-savannakhet-savan-resorts", name: "Savan Resorts", city: "Savannakhet", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 3.0, scale: 5, count: 122, url: "https://www.tripadvisor.com/Hotel_Review-g811038-d1492807-Reviews-Savan_Resorts-Savannakhet_Savannakhet_Province.html", asOf: "2026-07" },
    ],
    categories: ["stay", "resort", "hotel"], budgetTier: "high",
    stayType: "resort", stayDuration: "short", kidFriendly: true,
    amenities: ["restaurant", "casino", "pool", "air-con", "wifi", "entertainment"],
    blurb: "A large lifestyle resort and casino complex on the edge of Savannakhet with 400-plus rooms, mixed Lane Xang and southern-Lao-inspired architecture, and an in-house cafe serving Lao, Indian, Mexican and American food at reasonable prices.",
    whyItFits: "The most comfortable, full-facility stay in the Savannakhet area for travellers wanting a resort-style room rather than a simple guesthouse, including for a visa-run overnight.",
    priceRange: { low: 950000, typical: 1300000, high: 2000000, currency: "LAK", note: "Per night for a standard room; rates vary with promotions and season." },
    hours: "Check-in typically from 14:00",
    tips: ["It sits on the edge of town, so factor in a short tuk-tuk or taxi ride to the old French quarter.", "The casino draws a mixed crowd of visa-run visitors and regional gamblers, if that matters to you.", "Book directly or through a major booking site for the best promotional rate."],
    scamWarnings: [],
    rating: 3.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
  ...
  },
  {
    ...
    externalRatings: [
      { site: "Tripadvisor", score: 3.0, scale: 5, count: 108, url: "https://www.tripadvisor.com/Hotel_Review-g811038-d1960991-Reviews-Leena_Guesthouse-Savannakhet_Savannakhet_Province.html", asOf: "2026-07" },
    ],
    categories: ["stay", "guesthouse"], budgetTier: "low",
    stayType: "guesthouse", stayDuration: "short", kidFriendly: true,
    amenities: ["air-con", "hot-water", "bicycle-rental", "laundry", "wifi", "tour-desk"],
    blurb: "A family-run budget guesthouse in central Savannakhet with air-conditioned rooms, hot showers, bicycle rental and a helpful, English-speaking owner used to arranging onward travel and dining tips.",
    whyItFits: "A straightforward, well-located budget base for travellers overnighting in Savannakhet en route between Vientiane and southern Laos.",
    priceRange: { low: 90000, typical: 160000, high: 300000, currency: "LAK", note: "Per night for a fan or air-con double room." },
    hours: "Check-in typically from 13:00",
    tips: ["Hire a bicycle here to reach That Ing Hang or the riverfront.", "The owner can help plan onward bus connections south to Pakse or north to Vientiane.", "Ask for a room away from the street if noise is a concern."],
    scamWarnings: [],
    rating: 3.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Leena Guesthouse Savannakhet", coords: { lat: 16.5604, lng: 104.7527 },
    bookHint: "Book via Booking.com/Agoda, or walk in outside peak season.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Hotel_Review-g811038-d1960991-Reviews-Leena_Guesthouse-Savannakhet_Savannakhet_Province.html" }],
  },
  {
    id: "la-ext-savannakhet-souannavong-guesthouse", name: "Souannavong Guesthouse", city: "Savannakhet", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 3.0, scale: 5, count: 43, url: "https://www.tripadvisor.com/Hotel_Review-g811038-d4555571-Reviews-Souannavong_Guesthouse-Savannakhet_Savannakhet_Province.html", asOf: "2026-07" },
    ],
    categories: ["stay", "guesthouse"], budgetTier: "low",
    stayType: "guesthouse", stayDuration: "short", kidFriendly: true,
    amenities: ["air-con", "hot-water", "wifi", "restaurant"],
    blurb: "A small, friendly guesthouse on Saenna Road in central Savannakhet, run by an owner who speaks English, French and Lao/Thai and is known for going out of her way with directions and dining recommendations.",
    whyItFits: "A dependable, well-located budget option with a genuinely helpful host, for travellers who value local advice over resort facilities.",
    priceRange: { low: 80000, typical: 140000, high: 260000, currency: "LAK", note: "Per night for a simple air-con room." },
    hours: "Check-in typically from 13:00",
    tips: ["Ask the owner for restaurant and transport recommendations — reviewers specifically praise this.", "Rooms are basic, so this suits travellers prioritising location and hospitality over comfort.", "Central Saenna Road location is an easy walk to the old quarter."],
    scamWarnings: [],
    rating: 3.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Souannavong Guesthouse Savannakhet", coords: { lat: 16.5610, lng: 104.7520 },
    bookHint: "Book via Booking.com/Agoda, or walk in outside peak season.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Hotel_Review-g811038-d4555571-Reviews-Souannavong_Guesthouse-Savannakhet_Savannakhet_Province.html" }],
  },

  {
    id: "la-ext-phonsavan-nisha-restaurant", name: "Nisha Restaurant", city: "Phonsavan", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 4.1, scale: 5, count: 186, url: "https://www.tripadvisor.com/Restaurant_Review-g612364-d1167059-Reviews-Nisha_Restaurant-Phonsavan_Xiangkhouang_Province.html", asOf: "2026-07" },
    ],
    categories: ["food", "restaurant"], budgetTier: "low",
    isLocal: false, kidFriendly: true,
    blurb: "A long-running Indian restaurant on Route 7 in Phonsavan, run by an Indian owner who has lived in Laos for two decades. Serves curries, dal and fresh-baked bread, and is the only halal option in town, within walking distance of the market and bus station.",
    whyItFits: "A reliable, well-priced change of cuisine between Plain of Jars visits, and one of the most consistently reviewed restaurants in Phonsavan.",
    priceRange: { low: 18000, typical: 30000, high: 55000, currency: "LAK", note: "Per person for a curry and rice or naan; vegetarian dishes cost less than meat ones." },
    hours: "Roughly 07:00-21:30 daily",
    afterDark: { openAfterDark: true, note: "From this entry's own listed hours (Roughly 07:00-21:30 daily), which run past typical dusk in the region (about 17:45-18:45 by season). Lighting is not recorded." },
    tips: ["Order breakfast the night before if you have an early onward bus — the owner will pack it for you.", "It is the only halal restaurant in Phonsavan.", "Located on Route 7, an easy walk from the market and most guesthouses."],
    scamWarnings: [],
    rating: 4.1, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Nisha Restaurant Phonsavan", coords: { lat: 19.4501, lng: 103.2201 },
    bookHint: "Walk in; no reservations needed.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Restaurant_Review-g612364-d1167059-Reviews-Nisha_Restaurant-Phonsavan_Xiangkhouang_Province.html" }],
  },
  {
    id: "la-ext-phonsavan-bamboozle", name: "Bamboozle Restaurant & Bar", city: "Phonsavan", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 4.0, scale: 5, count: 261, url: "https://www.tripadvisor.com/Restaurant_Review-g612364-d2452059-Reviews-Bamboozle_Restaurant_Bar-Phonsavan_Xiangkhouang_Province.html", asOf: "2026-07" },
    ],
    categories: ["food", "restaurant"], budgetTier: "mid",
    isLocal: false, kidFriendly: true,
    blurb: "A bamboo-themed restaurant and bar in Phonsavan popular with both travellers and locals, serving homemade pizzas, burgers, tofu laap and a wider international-and-Asian menu alongside a good drinks list.",
    whyItFits: "The most sociable place in Phonsavan for an evening meal or a drink, with a broader international menu than the town's other options.",
    priceRange: { low: 40000, typical: 80000, high: 150000, currency: "LAK", note: "Per person for a pizza or burger and a drink." },
    hours: "Roughly 11:00-22:00 daily",
    afterDark: { openAfterDark: true, note: "From this entry's own listed hours (Roughly 11:00-22:00 daily), which run past typical dusk in the region (about 17:45-18:45 by season). Lighting is not recorded." },
    tips: ["The 12-inch homemade pizzas and burgers are the standout order.", "Good place to meet other travellers before or after a Plain of Jars day tour.", "Service can be slow at busy times — order early if you have a bus to catch."],
    scamWarnings: [],
    rating: 4.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Bamboozle Restaurant Bar Phonsavan", coords: { lat: 19.4570, lng: 103.2150 },
    bookHint: "Walk in; no reservations needed.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Restaurant_Review-g612364-d2452059-Reviews-Bamboozle_Restaurant_Bar-Phonsavan_Xiangkhouang_Province.html" }],
  },
  {
    id: "la-ext-phonsavan-kongkeo-guesthouse", name: "Kong Keo Guesthouse & Tours", city: "Phonsavan", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 4.0, scale: 5, count: 133, url: "https://www.tripadvisor.com/Hotel_Review-g612364-d2006245-Reviews-Kong_Keo_Guesthouse_Tours-Phonsavan_Xiangkhouang_Province.html", asOf: "2026-07" },
    ],
    categories: ["stay", "guesthouse"], budgetTier: "low",
    stayType: "guesthouse", stayDuration: "short", kidFriendly: true,
    amenities: ["tour-desk", "hot-water", "campfire", "restaurant"],
    blurb: "A Phonsavan institution down a lane near the market and bus station, long directed by Mr Kong himself, who guides the guesthouse's own Plain of Jars and war-history tours and gathers guests around an evening fireplace to talk Lao history.",
    whyItFits: "For travellers who want the guided-tour-plus-guesthouse combination in one place, with the owner's deep local knowledge as the main draw.",
    priceRange: { low: 100000, typical: 180000, high: 320000, currency: "LAK", note: "Per night for a basic room with private bathroom; tours are booked and paid separately." },
    hours: "Check-in typically from 13:00",
    tips: ["Book the guesthouse's own Plain of Jars tour directly with Mr Kong for the local-history angle.", "Join the evening fireplace gathering — it is part of the guesthouse's character.", "Rooms are basic; this is a stay for the tours and atmosphere rather than luxury."],
    scamWarnings: ["Confirm the exact tour itinerary and group size before paying, as some tours run only once a minimum group size is reached."],
    rating: 4.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Kong Keo Guesthouse Phonsavan", coords: { lat: 19.4509, lng: 103.2214 },
    bookHint: "Walk in, or book via Booking.com/Agoda ahead of high season.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Hotel_Review-g612364-d2006245-Reviews-Kong_Keo_Guesthouse_Tours-Phonsavan_Xiangkhouang_Province.html" }],
  },
  {
    id: "la-ext-phonsavan-maly-hotel", name: "Maly Hotel", city: "Phonsavan", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 3.0, scale: 5, count: 51, url: "https://www.tripadvisor.com/Hotel_Review-g612364-d504488-Reviews-Maly_Hotel-Phonsavan_Xiangkhouang_Province.html", asOf: "2026-07" },
    ],
    categories: ["stay", "hotel"], budgetTier: "mid",
    stayType: "hotel", stayDuration: "short", kidFriendly: true,
    amenities: ["wifi", "air-con", "restaurant", "breakfast-included"],
    blurb: "An established Phonsavan hotel with large, if dated, rooms, reverse-cycle air conditioning and free wifi, set a little away from the town centre. Breakfast is included in the room rate.",
    whyItFits: "A step up in room size from the budget guesthouses for travellers who want more space and don't mind an older building.",
    priceRange: { low: 400000, typical: 550000, high: 800000, currency: "LAK", note: "Per night for a standard double room, breakfast included." },
    hours: "Check-in typically from 14:00",
    tips: ["Rooms are large but dated — check a couple before settling in if you can.", "It is some distance from the main tourist strip, so factor in a short tuk-tuk ride.", "Breakfast is basic; supplement with a stop at a market stall or cafe in town."],
    scamWarnings: [],
    rating: 3.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Maly Hotel Phonsavan", coords: { lat: 19.4600, lng: 103.2100 },
    bookHint: "Book via Booking.com/Agoda, or call ahead directly.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Hotel_Review-g612364-d504488-Reviews-Maly_Hotel-Phonsavan_Xiangkhouang_Province.html" }],
  },
  {
    id: "la-ext-phonsavan-vansana-plain-of-jars", name: "Vansana Plain of Jars Hotel", city: "Phonsavan", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 3.0, scale: 5, count: 347, url: "https://www.tripadvisor.com/Hotel_Review-g612364-d951022-Reviews-Vansana_Plain_of_Jars_Hotel-Phonsavan_Xiangkhouang_Province.html", asOf: "2026-07" },
    ],
    categories: ["stay", "hotel"], budgetTier: "mid",
    stayType: "hotel", stayDuration: "short", kidFriendly: true,
    amenities: ["wifi", "air-con", "restaurant", "bar"],
    blurb: "A mid-range hotel on the edge of Phonsavan built in a traditional style, with straightforward air-conditioned rooms and an in-house restaurant and bar, one of the larger and longer-established hotels serving the Plain of Jars trade.",
    whyItFits: "A dependable mid-range option with more hotel-style facilities than the town's guesthouses, useful for groups or families visiting the Plain of Jars.",
    priceRange: { low: 550000, typical: 800000, high: 1200000, currency: "LAK", note: "Per night for a standard double room." },
    hours: "Check-in typically from 14:00",
    tips: ["It sits a little out from the town centre, so confirm transfer options when booking.", "The restaurant and bar are convenient if you would rather not go back into town for dinner.", "Book ahead in the dry season (roughly November-March), the region's high season."],
    scamWarnings: [],
    rating: 3.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Vansana Plain of Jars Hotel Phonsavan", coords: { lat: 19.4550, lng: 103.2050 },
    bookHint: "Book via Booking.com/Agoda or the hotel's own booking channels.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Hotel_Review-g612364-d951022-Reviews-Vansana_Plain_of_Jars_Hotel-Phonsavan_Xiangkhouang_Province.html" }],
  },

  {
    id: "la-ext-pakse-dok-mai-lao-caffe", name: "Dok Mai Lao Caffe Restaurant", city: "Pakse", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 4.7, scale: 5, count: 388, url: "https://www.tripadvisor.com/Restaurant_Review-g670161-d4185848-Reviews-Dok_Mai_Lao_Caffe_Restaurant-Pakse_Champasak_Province.html", asOf: "2026-07" },
    ],
    categories: ["food", "restaurant", "cafe"], budgetTier: "mid",
    isLocal: false, kidFriendly: true,
    blurb: "Pakse's top-rated restaurant, a genuinely Italian kitchen on a quiet central street with a hidden garden dining area out back. An Italian chef makes crisp woodfired pizza and fresh pasta with imported Italian cheese, a surprising find in southern Laos.",
    whyItFits: "The best-reviewed restaurant in Pakse and a favourite pre- or post-Bolaven Loop treat for travellers craving proper Italian cooking.",
    priceRange: { low: 60000, typical: 100000, high: 180000, currency: "LAK", note: "Per person for a pizza or pasta dish and a drink." },
    hours: "Roughly 11:00-22:00 daily",
    afterDark: { openAfterDark: true, note: "From this entry's own listed hours (Roughly 11:00-22:00 daily), which run past typical dusk in the region (about 17:45-18:45 by season). Lighting is not recorded." },
    tips: ["Ask to be seated in the garden out back — most of the atmosphere is there rather than at the street-front tables.", "The pizza and homemade pasta are the reason it is ranked #1 in town.", "It is walkable from most central Pakse guesthouses and the market."],
    scamWarnings: [],
    rating: 4.7, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Dok Mai Lao Caffe Restaurant Pakse", coords: { lat: 15.1213, lng: 105.8019 },
    bookHint: "Walk in; reservations helpful for larger groups in high season.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Restaurant_Review-g670161-d4185848-Reviews-Dok_Mai_Lao_Caffe_Restaurant-Pakse_Champasak_Province.html" }],
  },
  {
    id: "la-ext-pakse-le-panorama", name: "Le Panorama Rooftop Restaurant", city: "Pakse", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 4.0, scale: 5, count: 323, url: "https://www.tripadvisor.com/Restaurant_Review-g670161-d2623608-Reviews-Le_Panorama-Pakse_Champasak_Province.html", asOf: "2026-07" },
    ],
    categories: ["food", "restaurant"], budgetTier: "mid",
    isLocal: false, kidFriendly: true,
    blurb: "The 7th-floor rooftop restaurant of the Pakse Hotel, with a wraparound view over the city, the Mekong and the surrounding mountains. Serves Lao, Western and fusion dishes plus good pizza, with a daily happy hour on drinks.",
    whyItFits: "The best sunset view over Pakse of any restaurant in town, a natural spot for a final evening before or after the Bolaven Loop.",
    priceRange: { low: 60000, typical: 120000, high: 220000, currency: "LAK", note: "Per person for a main course and a drink; happy hour (17:00-18:00) takes 20% off drinks." },
    hours: "Daily from about 16:30; happy hour 17:00-18:00",
    tips: ["Arrive for sunset and stay for the happy hour on drinks.", "The pizza is a reliable order alongside the Lao and fusion mains.", "It is on the 7th floor of the Pakse Hotel in the town centre — take the lift up."],
    scamWarnings: [],
    rating: 4.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Le Panorama Rooftop Restaurant Pakse Hotel", coords: { lat: 15.1198, lng: 105.7987 },
    bookHint: "Walk in, or call the Pakse Hotel ahead for a table at sunset.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Restaurant_Review-g670161-d2623608-Reviews-Le_Panorama-Pakse_Champasak_Province.html" }],
  },
  {
    id: "la-ext-pakse-residence-sisouk", name: "Residence Sisouk", city: "Pakse", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 4.3, scale: 5, count: 366, url: "https://www.tripadvisor.com/Hotel_Review-g670161-d1953906-Reviews-Residence_Sisouk-Pakse_Champasak_Province.html", asOf: "2026-07" },
    ],
    categories: ["stay", "hotel"], budgetTier: "high",
    stayType: "hotel", stayDuration: "short", kidFriendly: true,
    amenities: ["restaurant", "wifi", "air-con", "colonial-architecture"],
    blurb: "A small boutique hotel in a restored colonial building in Pakse's old French quarter, with hardwood floors and staircases, tastefully furnished rooms and a ground-floor cafe-restaurant. Widely regarded as the best small hotel in town.",
    whyItFits: "Pakse's top-rated boutique stay, for travellers wanting colonial-era character and genuine hospitality over a big chain hotel.",
    priceRange: { low: 650000, typical: 900000, high: 1400000, currency: "LAK", note: "Per night for a standard room; larger suites cost more." },
    hours: "Check-in typically from 14:00",
    tips: ["It is a short walk from the bus station and Wat Luang, in the old French quarter.", "Book ahead — the hotel has few rooms and fills quickly in high season.", "The ground-floor cafe-restaurant is worth a stop even if you stay elsewhere."],
    scamWarnings: [],
    rating: 4.3, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Residence Sisouk Pakse", coords: { lat: 15.1195, lng: 105.7973 },
    bookHint: "Book direct via residence-sisouk.com or through Booking.com/Agoda well ahead of high season.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Hotel_Review-g670161-d1953906-Reviews-Residence_Sisouk-Pakse_Champasak_Province.html" }],
  },
  {
    id: "la-ext-pakse-xuanmai-garden-resort", name: "Xuanmai Garden Resort", city: "Pakse", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 4.0, scale: 5, count: 56, url: "https://www.tripadvisor.com/Hotel_Review-g670161-d11869336-Reviews-Xuanmai_Garden_Resort-Pakse_Champasak_Province.html", asOf: "2026-07" },
    ],
    categories: ["stay", "guesthouse"], budgetTier: "mid",
    stayType: "guesthouse", stayDuration: "short", kidFriendly: true,
    amenities: ["garden", "wifi", "parking", "restaurant"],
    blurb: "A quiet garden guesthouse a few kilometres from central Pakse, with large, clean rooms around a leafy compound run by an especially attentive owner who helps with bus tickets, tours and questions.",
    whyItFits: "A relaxed, good-value alternative to the town-centre cluster for travellers who don't mind a short motorbike or tuk-tuk ride in for meals and the market.",
    priceRange: { low: 300000, typical: 450000, high: 650000, currency: "LAK", note: "Per night for a garden room; credit cards are not accepted, so bring cash." },
    hours: "Check-in typically from 13:00",
    tips: ["It sits about 4 km from the centre, so renting a motorbike or arranging a tuk-tuk is worthwhile.", "Cash only — there is no card payment on site.", "Ask the owner for help with onward bus tickets and Bolaven tour planning."],
    scamWarnings: [],
    rating: 4.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Xuanmai Garden Resort Pakse", coords: { lat: 15.1182, lng: 105.8485 },
    bookHint: "Book via Booking.com/Agoda, or call ahead directly.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Hotel_Review-g670161-d11869336-Reviews-Xuanmai_Garden_Resort-Pakse_Champasak_Province.html" }],
  },
  {
    id: "la-ext-pakse-champasak-grand-hotel", name: "Champasak Grand Hotel", city: "Pakse", country: "la",
    externalRatings: [
      { site: "Tripadvisor", score: 3.0, scale: 5, count: 301, url: "https://www.tripadvisor.com/Hotel_Review-g670161-d1206679-Reviews-Champasak_Grand_Hotel-Pakse_Champasak_Province.html", asOf: "2026-07" },
    ],
    categories: ["stay", "hotel"], budgetTier: "mid",
    stayType: "hotel", stayDuration: "short", kidFriendly: true,
    amenities: ["pool", "restaurant", "gym", "wifi", "air-con", "riverfront"],
    blurb: "The largest hotel in Pakse, a 215-room riverfront property near the Lao-Nippon Bridge with views over the Mekong, three restaurants, a pool and a fitness centre — a full-facility business hotel rather than a boutique stay.",
    whyItFits: "For travellers wanting hotel-standard facilities (pool, gym, multiple restaurants) and Mekong views, at a larger scale than Pakse's guesthouses and small hotels.",
    priceRange: { low: 850000, typical: 1100000, high: 1600000, currency: "LAK", note: "Per night for a standard river-view room; rates vary with promotions." },
    hours: "Check-in typically from 14:00",
    tips: ["Ask for a room facing the Mekong for the view.", "It is a little out from the old French-quarter guesthouse cluster, so factor in a short tuk-tuk to the centre.", "The pool and gym are useful if you want downtime between Bolaven Loop days."],
    scamWarnings: [],
    rating: 3.0, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Champasak Grand Hotel Pakse", coords: { lat: 15.1320, lng: 105.7950 },
    bookHint: "Book via Booking.com/Agoda or the hotel's own website.", verified: "2026-08",
    sources: [{ org: "Tripadvisor", url: "https://www.tripadvisor.com/Hotel_Review-g670161-d1206679-Reviews-Champasak_Grand_Hotel-Pakse_Champasak_Province.html" }],
  },
  // Task #142 "do it all" pass, continued: Laos (7 towns), same combined "money, health &
  // connectivity" card shape as the Cambodia block just shipped, one card per town.
  // Country-wide facts (ATM fees, Unitel/Lao Telecom SIM pricing, the Kip's non-
  // convertibility) hold across all 7; only the named hospital/clinic is genuinely
  // town-specific. Caught one bad source this pass: a search for Nong Khiaw's nearest
  // hospital returned "cross into Thailand at Nong Khai/Udon Thani" - geographically
  // wrong, since Nong Khai is near VIENTIANE, hundreds of km from Nong Khiaw's actual
  // location in Luang Prabang province. Discarded that claim and used the correct,
  // already-sourced fact instead (Luang Prabang is the real regional hospital hub) -
  // same "don't trust a source that fails a basic sanity check" discipline as Run 10's
  // rating catch, just applied to a geography claim instead of arithmetic.
  {
    id: "la-ext-vientiane-practical", name: "Vientiane practical: money, health & connectivity", city: "Vientiane", country: "la",
    categories: ["practical", "info"], budgetTier: "low", kidFriendly: true,
    blurb: "The Lao Kip (LAK) is the working currency and cannot be exchanged outside Laos, so budget to spend or reconvert any large surplus before leaving. BCEL ATMs are the most reliable and widespread; foreign cards pay roughly 20,000-40,000 LAK per withdrawal (some banks add a further 2-4%), with daily limits typically 1-2 million LAK (up to 3 million at BFL) - no fee-free ATM exists. Unitel is the largest, most reliable network for a tourist SIM (from about 9-31 USD-equivalent for a data package); Lao Telecom is the alternative. For health, Mahosot, Setthathirat and Mittaphab hospitals plus the newer Alliance International Medical Centre give the capital genuinely better options than anywhere else in the country.",
    whyItFits: "The orientation card for money, connectivity and health in the capital - the one city in Laos where 'go to a real hospital' doesn't mean leaving town.",
    priceRange: { low: 20000, typical: 30000, high: 40000, currency: "LAK", note: "ATM withdrawal fee roughly 20,000-40,000 LAK; a Unitel tourist SIM data package runs from about 9 USD-equivalent." },
    hours: "ATMs 24h; Alliance International Medical Centre and the main hospitals run daytime hours with emergency departments available around the clock.",
    tips: ["Use a BCEL ATM where possible - the most reliable and widely distributed network for foreign cards.", "Don't leave Laos with a large stash of unspent Kip - it is a non-convertible currency and cannot be exchanged once you're across the border.", "Alliance International Medical Centre is the newest, most modern option with English-speaking staff if choosing where to go matters to you.", "Hospitals in Laos generally require a cash deposit before treatment begins - keep this in mind for anything beyond routine care."],
    scamWarnings: ["No ATM in Laos is fee-free for foreign cards - treat any claim otherwise with suspicion."],
    mapQuery: "Alliance International Medical Centre Vientiane", coords: { lat: 17.9757, lng: 102.6331 },
    bookHint: "No booking for ATMs/SIM; hospitals take emergency walk-ins and phone-ahead scheduled visits.", verified: "2026-08",
    sources: [{ org: "ASocialNomad — Laos ATM Fees 2026", url: "https://asocialnomad.com/laos/laos-costs-money/" }, { org: "Asian Nomad Hub — Laos SIM Cards & eSIMs 2026", url: "https://asiannomadhub.com/blog/laos-sim-cards-esims-2026-guide" }, { org: "Inside Laos — Hospitals in Vientiane", url: "https://inside-laos.com/vientiane/healthcare/hospitals/" }],
  },
  {
    id: "la-ext-luangprabang-practical", name: "Luang Prabang practical: money, health & connectivity", city: "Luang Prabang", country: "la",
    categories: ["practical", "info"], budgetTier: "low", kidFriendly: true,
    blurb: "Same nationwide Kip/ATM-fee picture as the rest of Laos (roughly 20,000-40,000 LAK per foreign-card withdrawal), with Unitel and Lao Telecom SIM counters around the old town. Luang Prabang Provincial Hospital on Route 13 north of town runs a 24-hour emergency room with X-ray and blood-lab facilities; the private Lao-Viet Friendship Clinic offers faster service and English-speaking doctors for less urgent needs. As the country's main tourist hub outside Vientiane, this is one of the better-equipped towns in Laos medically, though still a step below the capital.",
    whyItFits: "The orientation card for money, connectivity and health in the country's most-visited town outside the capital.",
    priceRange: { low: 20000, typical: 30000, high: 40000, currency: "LAK", note: "ATM withdrawal fee roughly 20,000-40,000 LAK; a Unitel tourist SIM data package runs from about 9 USD-equivalent." },
    hours: "ATMs 24h; Luang Prabang Provincial Hospital runs a 24-hour emergency room (071-212-049); Lao-Viet Friendship Clinic keeps standard daytime clinic hours.",
    tips: ["Luang Prabang Provincial Hospital's emergency room (071-212-049) is the standard call for anything urgent.", "The private Lao-Viet Friendship Clinic is the faster, English-speaking option for non-emergency care.", "Bring or withdraw enough Kip here before heading onward to smaller towns like Nong Khiaw, which have fewer ATMs.", "Hospitals in Laos generally require a cash deposit before treatment - budget for this even with insurance."],
    scamWarnings: [],
    mapQuery: "Luang Prabang Provincial Hospital", coords: { lat: 19.8845, lng: 102.1348 },
    bookHint: "No booking for ATMs/SIM; the hospital ER and Lao-Viet Friendship Clinic both take walk-ins.", verified: "2026-08",
    sources: [{ org: "Inside Laos — Hospitals in Luang Prabang", url: "https://inside-laos.com/luang-prabang/healthcare/hospitals/" }, { org: "Trails of Indochina — Laos Medical Facilities", url: "https://www.trailsofindochina.com/wp-content/uploads/2019/02/Laos_MEDICAL-FACILITIES.pdf" }],
  },
  {
    id: "la-ext-vangvieng-practical", name: "Vang Vieng practical: money, health & connectivity", city: "Vang Vieng", country: "la",
    categories: ["practical", "info"], budgetTier: "low", kidFriendly: true,
    blurb: "Same nationwide Kip/ATM-fee picture as the rest of Laos, with Unitel and Lao Telecom SIM counters along the main tourist strip. Vang Vieng District Hospital (+856 23 511 019) is a small facility that handles typical issues - stomach problems, broken bones, flu - competently, alongside the private Thang Long Vang Vieng International Clinic, but serious or complex cases need transfer to Vientiane, about 3-4 hours south by road.",
    whyItFits: "The orientation card for a town whose adventure-tourism activities (tubing, kayaking, ziplining) mean minor injuries are common, but real trauma care means Vientiane.",
    priceRange: { low: 20000, typical: 30000, high: 40000, currency: "LAK", note: "ATM withdrawal fee roughly 20,000-40,000 LAK; a Unitel tourist SIM data package runs from about 9 USD-equivalent." },
    hours: "ATMs 24h; Vang Vieng District Hospital and Thang Long International Clinic keep standard hours with emergency care available.",
    tips: ["Vang Vieng District Hospital (+856 23 511 019) handles common injuries and illness well - it's the right first call for anything short of a serious trauma.", "Thang Long Vang Vieng International Clinic is the private alternative many tourists use.", "For serious injuries from tubing, kayaking or ziplining accidents, transfer to Vientiane (3-4 hours by road) is the realistic next step - travel insurance with evacuation cover matters here specifically.", "Confirm your insurance covers adventure-activity injuries before doing anything higher-risk here - this is a genuinely common gap in standard policies."],
    scamWarnings: [],
    mapQuery: "Vang Vieng District Hospital", coords: { lat: 18.9237, lng: 102.4470 },
    bookHint: "No booking for ATMs/SIM; the district hospital and Thang Long clinic both take walk-ins.", verified: "2026-08",
    sources: [{ org: "Inside Laos — Healthcare in Vang Vieng", url: "https://inside-laos.com/vang-vieng/healthcare/" }, { org: "SafetyWing — Thang Long Vang Vieng International Clinic", url: "https://safetywing.com/nomad-care-map/laos/vang-vieng_vientiane/thang-long-vang-vieng-international-clinic" }],
  },
  {
    id: "la-ext-pakse-practical", name: "Pakse practical: money, health & connectivity", city: "Pakse", country: "la",
    categories: ["practical", "info"], budgetTier: "low", kidFriendly: true,
    blurb: "Same nationwide Kip/ATM-fee picture as the rest of Laos, with Unitel and Lao Telecom SIM counters around the old French-quarter guesthouse cluster. Champasak Provincial Hospital is the main public facility for southern Laos but sits below Western standards; the adjoining International Poly Clinic (also known as Pakse International Clinic) is the region's leading private option, with English-speaking staff, X-ray and lab testing, and modern facilities - the standard recommendation for tourists over the public hospital.",
    whyItFits: "The orientation card for the southern gateway town, and the honest steer toward the private clinic over the public hospital for anything beyond a minor complaint.",
    priceRange: { low: 20000, typical: 30000, high: 40000, currency: "LAK", note: "ATM withdrawal fee roughly 20,000-40,000 LAK; a Unitel tourist SIM data package runs from about 9 USD-equivalent." },
    hours: "ATMs 24h; International Poly Clinic keeps standard daytime clinic hours with emergency capability.",
    tips: ["Head to the International Poly Clinic (Pakse International Clinic), not the public Champasak Provincial Hospital, for anything beyond a minor complaint - it is the standard advice from travellers and expats alike.", "Bring a passport photocopy if you do need to use Champasak Provincial Hospital.", "Pakse is the usual base before the Bolaven Plateau loop - sort cash and a SIM here before heading out, since coverage and ATMs thin out on the loop itself."],
    scamWarnings: [],
    mapQuery: "International Poly Clinic Pakse", coords: { lat: 15.1202, lng: 105.7820 },
    bookHint: "No booking for ATMs/SIM; International Poly Clinic takes walk-ins.", verified: "2026-08",
    sources: [{ org: "Wanderlog — Champasak Provincial Hospital, Pakse", url: "https://wanderlog.com/place/details/5763875/champasak-provincial-hospital" }, { org: "SafetyWing — Best Doctors and Hospitals in Pakse", url: "https://safetywing.com/nomad-care-map/laos/pakse_champasak-province" }],
  },
  {
    id: "la-ext-savannakhet-practical", name: "Savannakhet practical: money, health & connectivity", city: "Savannakhet", country: "la",
    categories: ["practical", "info"], budgetTier: "low", kidFriendly: true,
    blurb: "Same nationwide Kip/ATM-fee picture as the rest of Laos, with Unitel and Lao Telecom SIM counters around the city centre. Savannakhet Provincial Hospital (Ban Thahae) runs a 24-hour emergency department with a broad range of services, including ICU and orthopedic surgery, but foreigners are generally steered toward private care for anything serious - Dr Sisouphanh Clinic in the city centre is the commonly recommended private option, alongside Savannakhet-International Hospital for specialised needs like dialysis.",
    whyItFits: "The orientation card for a Mekong-border town that has real public hospital infrastructure, but where private care is still the recommended route for visitors.",
    priceRange: { low: 20000, typical: 30000, high: 40000, currency: "LAK", note: "ATM withdrawal fee roughly 20,000-40,000 LAK; a Unitel tourist SIM data package runs from about 9 USD-equivalent." },
    hours: "ATMs 24h; Savannakhet Provincial Hospital's outpatient department runs Mon-Fri 08:00-12:00 and 13:30-16:30, with 24-hour emergency response separately.",
    tips: ["Dr Sisouphanh Clinic (city centre, private) is the commonly recommended stop for visitors over the public hospital for non-emergency care.", "Savannakhet Provincial Hospital's emergency department and ambulance service run 24 hours, separate from its Mon-Fri outpatient hours.", "Savannakhet sits on a Mekong crossing to Thailand - if care needs exceed what's available locally, Mukdahan across the river or onward to a larger Thai city is a realistic option for those with the right visa/insurance."],
    scamWarnings: [],
    mapQuery: "Savannakhet Provincial Hospital", coords: { lat: 16.5560, lng: 104.7520 },
    bookHint: "No booking for ATMs/SIM; Savannakhet Provincial Hospital and Dr Sisouphanh Clinic both take walk-ins.", verified: "2026-08",
    sources: [{ org: "VFMatch — Savannakhet Hospital Facility", url: "https://vfmatch.org/explore/facilities/60ec6a045f0539007d1da54b" }, { org: "Expat Exchange — Health Care in Savannakhet", url: "https://www.expatexchange.com/ctryguide/10970/69/Laos/Health-Care-in-Savannakhet-Health-Care-in-Savannakhet" }],
  },
  {
    id: "la-ext-nongkhiaw-practical", name: "Nong Khiaw practical: money, health & connectivity", city: "Nong Khiaw", country: "la",
    categories: ["practical", "info"], budgetTier: "low", kidFriendly: true,
    blurb: "Same nationwide Kip/ATM-fee picture as the rest of Laos, though Nong Khiaw is small enough that ATMs and SIM top-up points are limited to a couple of spots near the bridge and bus station - sort cash and data in Luang Prabang before arriving if possible. This is a genuinely remote riverside village: local medical care is limited to a basic district health centre at most, and the honest answer for anything beyond a minor complaint is the roughly 2-3 hour road journey back to Luang Prabang Provincial Hospital, the real regional hospital hub - not a border crossing into Thailand, which sits hundreds of kilometres away near Vientiane and is not a realistic option from here.",
    whyItFits: "The honest orientation card for one of Laos's most remote hub towns - what genuinely exists locally, and exactly where 'real medical care' means going instead.",
    priceRange: { low: 20000, typical: 30000, high: 40000, currency: "LAK", note: "ATM withdrawal fee roughly 20,000-40,000 LAK where available; a Unitel tourist SIM data package runs from about 9 USD-equivalent, best bought in Luang Prabang given Nong Khiaw's limited shop selection." },
    hours: "The few ATMs near the bridge/bus station keep no guaranteed extended hours - don't rely on withdrawing late at night.",
    tips: ["Withdraw cash and buy a SIM in Luang Prabang before heading to Nong Khiaw - options here are genuinely limited.", "For anything beyond a minor complaint, the realistic plan is the 2-3 hour road trip back to Luang Prabang Provincial Hospital, not a local facility.", "Comprehensive travel insurance with medical evacuation cover matters more here than almost anywhere else covered in this app, given the genuine remoteness.", "Boat and trekking activities out of Nong Khiaw (to Muang Ngoi and beyond) go further from any medical care still - factor this into how remote an activity you choose."],
    scamWarnings: [],
    mapQuery: "Nong Khiaw bus station", coords: { lat: 20.5667, lng: 102.6167 },
    bookHint: "No booking for ATMs/SIM; for anything serious, head to Luang Prabang Provincial Hospital.", verified: "2026-08",
    sources: [{ org: "Travelfish — Healthcare in Laos", url: "https://www.travelfish.org/beginners_detail/laos/23" }, { org: "Inside Laos — Hospitals in Luang Prabang", url: "https://inside-laos.com/luang-prabang/healthcare/hospitals/" }],
  },
  {
    id: "la-ext-phonsavan-practical", name: "Phonsavan practical: money, health & connectivity", city: "Phonsavan", country: "la",
    categories: ["practical", "info"], budgetTier: "low", kidFriendly: true,
    blurb: "Same nationwide Kip/ATM-fee picture as the rest of Laos, with Unitel and Lao Telecom SIM counters in the town centre. Xieng Khouang Provincial Hospital is unusually well-equipped for a provincial facility - it has an X-ray machine and a small ICU, general surgery and infectious-disease care, and runs a long-standing partnership with Switzerland's Cantonal Hospital Winterthur (the Swiss Laos Hospital Project) that has raised its standard of care. Phonsavan Inter Hospital is a further private option in town.",
    whyItFits: "The orientation card for the Plain of Jars gateway town, which - thanks to a long-running Swiss hospital partnership - has better local medical infrastructure than its remote location might suggest.",
    priceRange: { low: 20000, typical: 30000, high: 40000, currency: "LAK", note: "ATM withdrawal fee roughly 20,000-40,000 LAK; a Unitel tourist SIM data package runs from about 9 USD-equivalent." },
    hours: "ATMs 24h; Xieng Khouang Provincial Hospital and Phonsavan Inter Hospital (+856 20 98 115 115) both run daytime hours with emergency capability.",
    tips: ["Xieng Khouang Provincial Hospital's Swiss-partnered infrastructure (X-ray, small ICU) makes it a genuinely reasonable first stop, unusually for a provincial hospital in Laos.", "Phonsavan Inter Hospital (+856 20 98 115 115) is the private alternative in town.", "UXO (unexploded ordnance) remains a real, specific local hazard around the Plain of Jars - stay strictly on marked paths, since this is not just generic caution but a documented risk unique to this province."],
    scamWarnings: [],
    mapQuery: "Xieng Khouang Provincial Hospital Phonsavan", coords: { lat: 19.4500, lng: 103.2000 },
    bookHint: "No booking for ATMs/SIM; both hospitals take walk-in emergencies.", verified: "2026-08",
    sources: [{ org: "Swiss Laos Hospital Project — Locations", url: "https://www.swisslaos.ch/en/locations/" }, { org: "VFMatch — Phonsavan Inter Hospital Facility", url: "https://vfmatch.org/explore/facilities/69855cf8fc75342c9fa3d15e" }],
  },
  // Task #142 transport-gap pass, continued: the 3 Laos towns that showed 0
  // transport-family entries in the same fresh live audit (Nong Khiaw, Phonsavan,
  // Savannakhet). Same combined single-card shape as the Vietnam block just shipped.
  {
    id: "la-ext-nongkhiaw-transport", name: "Nong Khiaw practical: getting there and around", city: "Nong Khiaw", country: "la",
    categories: ["transport", "info"], budgetTier: "low", kidFriendly: true,
    blurb: "Nong Khiaw has no airport or rail link - the standard route in is a 4-5 hour bus or minivan from Luang Prabang (from around $3 for the cheapest mini bus up to about $13 for a more comfortable minivan, with roughly 7 services a day). From Nong Khiaw itself, a scheduled boat up the Nam Ou River to Muang Ngoi leaves the jetty around 11:00 (roughly 25,000-40,000 kip per person as of the most recent pricing, though this has shifted before and is worth confirming at the ticket office); a private charter at another time runs 80,000-120,000 kip. Within Nong Khiaw village itself, everything is walkable - there's little need for a tuk-tuk beyond reaching the bus station or jetty with luggage.",
    whyItFits: "The orientation card for a remote riverside hub with no airport or rail: the realistic road route in, and the river route onward to Muang Ngoi.",
    priceRange: { low: 25000, typical: 60000, high: 120000, currency: "LAK", note: "The Luang Prabang bus/minivan runs $3-13 (roughly 65,000-280,000 kip). The scheduled Muang Ngoi boat runs roughly 25,000-40,000 kip per person; a private charter runs 80,000-120,000 kip." },
    hours: "Buses/minivans from Luang Prabang run through the day; the scheduled Muang Ngoi boat leaves around 11:00, with return boats from Muang Ngoi around 08:00 and 14:00.",
    tips: ["Book the Luang Prabang-Nong Khiaw bus or minivan a day ahead in high season - there are only about 7 services a day.", "Confirm the Muang Ngoi boat's current price and departure time at the Nong Khiaw jetty ticket office - fares have shifted before and online figures can lag.", "A private charter boat is the only way to reach Muang Ngoi outside the roughly 11:00 scheduled departure.", "Nong Khiaw village itself is small enough to walk everywhere - save any vehicle hire for day trips further out."],
    scamWarnings: [],
    mapQuery: "Nong Khiaw bus station", coords: { lat: 20.5667, lng: 102.6167 },
    bookHint: "Bus/minivan tickets bookable online or via a Luang Prabang travel agent; boat tickets are bought same-day at the Nong Khiaw jetty.", verified: "2026-08",
    sources: [{ org: "Bookaway — Nong Khiaw to Luang Prabang", url: "https://www.bookaway.com/routes/laos/nong-khiaw-to-luang-prabang" }, { org: "Orange Wayfarer — Boat Trip Nong Khiaw to Muang Ngoi", url: "https://www.orangewayfarer.com/nong-khiaw-to-muang-ngoi/" }, { org: "Tourism Luang Prabang — Misty Mountains: Nong Khiaw to Muang Ngoi", url: "https://tourismluangprabang.org/recommended-trips/day-trips/misty-mountains-nong-khiaw-to-muang-ngoi/" }],
  },
  {
    id: "la-ext-phonsavan-transport", name: "Phonsavan practical: getting there and Plain of Jars transport", city: "Phonsavan", country: "la",
    categories: ["transport", "info"], budgetTier: "mid", kidFriendly: true,
    blurb: "Phonsavan has its own small airport (XKH) with a roughly 30-minute flight from Vientiane (from about $40-86 one-way) - a fast option worth the premium given the alternative is a 12-13 hour bus or minivan (from about $20). Once in town, reaching the Plain of Jars sites means a guided tour (transport, guide and often a driver included), a hired tuk-tuk, or a self-drive scooter (roughly 80,000 kip/day for a single-rider 80cc, 120,000 kip/day plus fuel for a 125cc suitable for two - a valid driving licence and helmet are required). Whichever way you go, UXO (unexploded ordnance) is a genuine, documented hazard here, not generic caution: stick strictly to paths marked as cleared by MAG (Mines Advisory Group) or NPA, at every jar site without exception.",
    whyItFits: "The orientation card for reaching a genuinely remote province and then moving safely between its jar sites, where UXO makes 'just wander off the path' a real and specific danger rather than boilerplate advice.",
    priceRange: { low: 20, typical: 55, high: 86, currency: "USD", note: "Bus/minivan from Vientiane runs from about $20 (12-13 hours); flight runs $40-86 (about 30 minutes). Local scooter hire runs roughly 80,000-120,000 kip/day plus fuel; a guided tour typically bundles transport into one price." },
    hours: "The Vientiane-Phonsavan flight typically operates daily; bus/minivan services run mostly daytime departures.",
    tips: ["Fly if the schedule allows it - 30 minutes versus 12-13 hours on the road is a large trade for a moderate fare difference.", "A guided tour is the simplest way to see multiple jar sites in a day without arranging your own transport.", "If self-driving a rented scooter, carry your driving licence and wear the helmet provided - both are checked and expected.", "Never step off a path marked as cleared by MAG or NPA at any Plain of Jars site - this is real, not routine caution, and applies across the whole province, not just the main tourist sites."],
    scamWarnings: [],
    mapQuery: "Phonsavan Xieng Khouang Airport", coords: { lat: 19.4500, lng: 103.2000 },
    bookHint: "Book flights online in advance; bus/minivan and scooter/tuk-tuk hire can usually be arranged same-day in town.", verified: "2026-08",
    sources: [{ org: "Bookaway — Vientiane to Phonsavan", url: "https://www.bookaway.com/routes/laos/vientiane-to-phonsavan" }, { org: "ASocialNomad — The Plain of Jars: How to Take a Tour", url: "https://asocialnomad.com/laos/plain-of-jars/" }, { org: "TripAdvisor — The Plain of Jars, Phonsavan", url: "https://www.tripadvisor.com/Attraction_Review-g612364-d325753-Reviews-The_Plain_Of_Jars-Phonsavan_Xiangkhouang_Province.html" }],
  },
  {
    id: "la-ext-savannakhet-transport", name: "Savannakhet practical: getting there and around", city: "Savannakhet", country: "la",
    categories: ["transport", "info"], budgetTier: "low", kidFriendly: true,
    blurb: "Savannakhet sits on the Mekong directly across from Mukdahan, Thailand, linked by the Second Thai-Lao Friendship Bridge (opened 2006) - a roughly 15-minute drive from Mukdahan city to the border, with buses reported to clear Thai immigration in under 5 minutes before crossing. This is also a working freight corridor on the East-West Economic Corridor (through to Da Nang, Vietnam, one way, and the Thai-Myanmar border the other), so it stays busy, though passenger processing itself runs smoothly. Within Laos, buses connect south to Pakse (about 247km, roughly 5 hours, 40,000 kip) and north to Vientiane (about 495km - a local bus takes roughly 10 hours for 75,000 kip, or a VIP night bus takes about 8 hours for 120,000 kip).",
    whyItFits: "The orientation card for a genuine Thailand-Laos land crossing point, plus the two realistic domestic bus routes onward from here.",
    priceRange: { low: 40000, typical: 75000, high: 120000, currency: "LAK", note: "Savannakhet-Pakse bus runs about 40,000 kip (5 hours). Savannakhet-Vientiane runs 75,000 kip on a local day bus (10 hours) or 120,000 kip on a VIP night bus (8 hours)." },
    hours: "The Friendship Bridge crossing itself runs long hours for freight; passenger buses and immigration processing generally run daytime and evening (VIP night bus departs around 21:00).",
    tips: ["If crossing from Mukdahan, budget for a working freight corridor - expect some slow-downs even though passenger/bus processing itself is reported as quick.", "Take the VIP night bus to Vientiane over the local day bus if the schedule allows - two hours faster for roughly 45,000 kip more.", "Buses to Pakse run several times a day (07:00, 09:00, 10:30, 14:00, 17:30) - there's no need to book far ahead outside peak season.", "Savannakhet's old quarter itself is compact and walkable - a vehicle is really only needed for the border crossing or the onward bus routes."],
    scamWarnings: [],
    mapQuery: "Savannakhet bus station", coords: { lat: 16.5560, lng: 104.7520 },
    bookHint: "Cross-border buses and domestic routes can be booked via a local agent or bought same-day at the bus station.", verified: "2026-08",
    sources: [{ org: "Border Crossing Hub — Mukdahan-Savannakhet Friendship Bridge II", url: "https://bordercrossinghub.com/mukdahan-savannakhet-friendship-bridge-ii-border-crossing/" }, { org: "Bookaway — Savannakhet to Vientiane", url: "https://www.bookaway.com/routes/laos/savannakhet-to-vientiane" }, { org: "Bookaway — Pakse to Savannakhet", url: "https://www.bookaway.com/routes/laos/pakse-to-savannakhet" }],
  },
  // ---- Run 15: hub-town coverage close-out (task #218) - Vang Vieng, Savannakhet and Nong Khiaw gaps, researched and cited 2026-08 ----
  {
    id: "la-ext-vangvieng-wat-kang-wat-that", name: "Wat Kang & Wat That, Vang Vieng", city: "Vang Vieng", country: "la",
    categories: ["temple", "culture", "heritage"], budgetTier: "low", kidFriendly: true,
    localName: "Wat Kang / Wat That",
    access: { stepFree: "partial", note: "Both temple compounds are flat, open ground that can be crossed without steps; the ordination halls themselves are raised on a low stepped platform." },
    afterDark: { openAfterDark: false, note: "Working village temples with daylight visiting only; there is no evening opening and no lighting in the compounds." },
    blurb: "Vang Vieng is sold as karst, tubing and balloons, and almost nobody notices that it is also an old Lao town with two working temples in the middle of it. Wat Kang's ordination hall dates from 1938 and is painted inside with murals telling Lao stories; a seated Buddha and a reclining Buddha rest in their own pavilions, four small Buddhas and a chedi stand in front, and a drum tower marks what was traditionally the centre of the settlement. Wat That, a few streets away, is the larger and better-kept of the two and is known for its golden stupa.",
    whyItFits: "The one genuinely cultural half-hour in a town that otherwise sells only adrenaline, and it costs nothing.",
    priceRange: { low: 0, typical: 0, high: 20000, currency: "LAK", note: "No entrance charge at either temple. A small donation in the box is customary." },
    hours: "Daylight hours daily; early morning is when the monks are about and the light is best",
    tips: ["Take the two together - they are a short walk apart in the old part of town, west of the main strip.", "These are active monasteries, not monuments: cover shoulders and knees, remove shoes before entering a hall, and do not point your feet at a Buddha image.", "Early morning gives you the almsgiving round and an empty compound; by mid-morning the heat and the tour traffic arrive.", "The old US-built airstrip, known as Lima Site 6, still dominates the eastern side of town and is worth a look on the way back for the other half of Vang Vieng's history."],
    scamWarnings: [],
    rating: 4.1, reviewSources: ["Lonely Planet", "Google Maps consensus"],
    mapQuery: "Wat Kang Vang Vieng", coords: { lat: 18.9235, lng: 102.4470 },
    bookHint: "No booking; walk in.", verified: "2026-08",
    sources: [{ org: "Lonely Planet - Wat Kang", url: "https://www.lonelyplanet.com/laos/northern-laos/vang-vieng/attractions/wat-kang/a/poi-sig/1354104/356933" }, { org: "Laos Life - Wat Kang, Vang Vieng", url: "https://www.laoslife.info/wat-kang-vang-vieng/" }],
  },
  {
    id: "la-ext-savannakhet-talat-savanxay", name: "Talat Savanxay (Savannakhet main market)", city: "Savannakhet", country: "la",
    categories: ["market", "food", "shopping"], budgetTier: "low", kidFriendly: true,
    localName: "Talat Savanxay",
    access: { stepFree: "partial", note: "A covered ground-level market with a level entrance, but the interior aisles are narrow and crowded and the produce section is often wet underfoot." },
    afterDark: { openAfterDark: false, note: "Closes at about 17:00 - a daytime market, busiest in the morning." },
    blurb: "Savannakhet's main covered market, a hundred metres east of the bus station, and the practical centre of the town. Fresh greens, meat and river fish in the morning; cheap cooked food through the middle of the day; and aisles of imported Thai and Vietnamese goods that show exactly where this Mekong border town sits between its two neighbours. Handicrafts and souvenirs occupy one end.",
    whyItFits: "Savannakhet is a slow, half-empty colonial town where the market is the one place with real energy, and it sits right next to the bus station most travellers pass through anyway.",
    priceRange: { low: 10000, typical: 30000, high: 80000, currency: "LAK", note: "A plate of cooked food runs roughly 15,000-35,000 LAK. Produce is sold by weight; handicrafts are negotiable." },
    hours: "Roughly 06:00-17:00 daily; busiest in the morning when locals shop",
    tips: ["Go before 09:00 for the real market - by afternoon it is mostly the dry-goods aisles.", "It is a hundred metres from the main bus station, which makes it the obvious way to fill a wait between connections.", "The prepared-food section in the middle of the day is the cheapest sit-down meal in town.", "Carry small kip notes; cards are not used and change for large notes is scarce."],
    scamWarnings: [],
    rating: 3.9, reviewSources: ["Wikivoyage", "Google Maps consensus"],
    mapQuery: "Talat Savanxay Savannakhet", coords: { lat: 16.5600, lng: 104.7540 },
    bookHint: "No booking; walk in.", verified: "2026-08",
    sources: [{ org: "Wikivoyage - Savannakhet", url: "https://en.wikivoyage.org/wiki/Savannakhet" }, { org: "SoiDB Laos - Talad Savanxay", url: "https://www.soidb.com/savannakhet/market/talad-savanxay.html" }],
  },
  {
    id: "la-ext-nongkhiaw-morning-market", name: "Nong Khiaw morning market", city: "Nong Khiaw", country: "la",
    categories: ["market", "food", "culture"], budgetTier: "low", kidFriendly: true,
    access: { stepFree: "partial", note: "An open-ground village market on flat but unpaved earth, which is passable slowly in the dry season and muddy after rain." },
    afterDark: { openAfterDark: false, note: "A pre-dawn to late-morning market that is finished by about 11:00; there is nothing here in the evening." },
    blurb: "Nong Khiaw's market opens in the dark and is over before most guests have had breakfast. Villagers come down from the surrounding hills with fresh produce, river fish, bagged curry paste, dried noodles and forest greens; there are Hmong embroidery and hill-tribe baskets at one end, and stalls doing noodle soup, fried rice and baguettes for less than the guesthouse cafes charge. Saturday is the big day and is visibly livelier than a weekday.",
    whyItFits: "The one hour of the day when Nong Khiaw is a working Lao village rather than a viewpoint-and-kayak town, and it is over by the time the boats leave.",
    priceRange: { low: 10000, typical: 25000, high: 60000, currency: "LAK", note: "A bowl of noodle soup or a filled baguette runs roughly 15,000-35,000 LAK - cheaper than anything on the main street." },
    hours: "Roughly 05:00-11:00, with the best of it before 08:00. Trading days are not perfectly consistent; Saturday is the big market day",
    tips: ["Set an alarm - by 09:00 the good produce has gone and by 11:00 the market has packed up.", "Eat breakfast here rather than at the guesthouse; the noodle stalls are better and a fraction of the price.", "Hmong embroidery and baskets are made locally and are worth buying here rather than in Luang Prabang.", "Carry small kip notes. There is one unreliable ATM in Nong Khiaw, so arrive with cash from Luang Prabang."],
    scamWarnings: [],
    rating: 4.2, reviewSources: ["Tripadvisor", "Google Maps consensus"],
    mapQuery: "Nong Khiaw morning market Laos", coords: { lat: 20.5670, lng: 102.6170 },
